...
The Bloomberg query Excel workbook for futures times series is available for download [here](./assets/workbooks/simple interface/futures.xlsm). The user interface to the query engine lives on the "Query" worksheet:  
