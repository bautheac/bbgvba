...
<center> ![Parameters table](./assets/pics/Futures - table - params.jpg "") </center>
...
<center> ![Fields table](./assets/pics/Futures - table - variables.jpg) </center>
...
* New query field:   
<center> ![Add query field](./assets/pics/Futures - table - add row.jpg) </center>
* Delete query field:  
<center> ![Delete query field](./assets/pics/Futures - table - delete row.jpg) </center>



### Tickers table

Tickers will also live on a dedicated table: 

<center> ![Tickers table](./assets/pics/Futures - table - tickers.jpg) </center>  
