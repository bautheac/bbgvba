...
The Bloomberg query Excel workbook for equity times series is available for download [here](./assets/workbooks/simple interface/equity.xlsm). The user interface to the query engine lives on the "Query" worksheet:  
